        ...
        return (
            <div>
                ...
                <table class="table">
                    ...
                    <tr>
                        <td width = {200}><a href="https://github.com/busycsu/WHP"><img class="myImg" src="/media/images/pic12.jpg" style={{width:"100%"}} /></a></td>
                    ...
                    <tr>
                        <td width = {200} ><a href="https://github.com/busycsu/finance-tracker"><img class="myImg" src="/media/images/pic8.jpg" style={{width:"100%"}} /></a></td>
